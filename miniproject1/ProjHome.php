        ...
        <div id="autoSuggestion">
            ...
            <br><br>
                <div class="autoContent">
                    <img class="imgAuto" src="phone.jpg" alt="iPhone"> Cell Phones
                </div>
                <div class="autoContent">
                    <img class="imgAuto" src="macbook.jpg" alt="Macbook">Laptops
                </div>
                <br>
                <div class="autoContent">
                    <img class="imgAuto" src="tv.jpg" alt="TV" href="TV.php">TV's
                </div>
                <div class="autoContent">
                    <img class="imgAuto" src="airpods.jpg" alt="Airpods" href="Earphones.php">Earphones
                </div>
            <br> <br>
